  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<MovieDetailsBloc>()
        ...
        ..add(GetRecommendedMoviesEvent(id: id)),
      lazy: false,
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            '${AppString.generes} ${_showGenres(state.movieDetails!.genres)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
                ...
                (context, index) {
                  ...
                  return FadeInUp(
                    ...
                    child: GestureDetector(
                      onTap: () =>Navigator.push(context, MaterialPageRoute(builder: (context) =>MovieDetailScreen(id: recommendation.id),)),
                      child: ClipRRect(
                        borderRadius:
                        ...
                        child: CachedNetworkImage(
                          imageUrl: ApiConstant.imageUrl(
                              recommendation.backdropPath ??
                                  "/z5A5W3WYJc3UVEWljSGwdjDgQ0j.jpg"),
